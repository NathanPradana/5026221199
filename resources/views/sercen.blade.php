...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Acer - Service Locations</title>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{url('sercen')}}" class="nav-item nav-link active">Service Center</a>
                        </div>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Service Center</h1>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid blog py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="sub-style">
                        <h4 class="sub-title px-3 mb-0">Locations</h4>
                    </div>
                    <h1 class="display-3 mb-4">Our Service Center</h1>
                    <p class="mb-0">We provide you with our best Service</p>
                </div>
                <div class="row g-4 justify-content-center">
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="https://lh5.googleusercontent.com/p/AF1QipMsylP2qAuL50T--bAOGCTLdJLpScXnMweWb_OM=w408-h306-k-no" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                </div>
                                <a href="https://maps.app.goo.gl/eEt4pir6rxywZeiZ6" class="h4">Acer Customer Service Center Surabaya</a>
                                <p class="my-4"></p>
                                <a href="https://maps.app.goo.gl/eEt4pir6rxywZeiZ6" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Maps</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="https://lh5.googleusercontent.com/p/AF1QipM3gL7kqJBLzBOQetIsOqe8hg5ao9MYyzaebLNw=w408-h306-k-no" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                </div>
                                <a href="https://maps.app.goo.gl/Bqix6QJbRZSagwCg9" class="h4">Acer Customer Service Center - Mangga Dua Square</a>
                                <p class="my-4"></p>
                                <a href="https://maps.app.goo.gl/Bqix6QJbRZSagwCg9" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Maps</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg62oQ9HBmUx0ZGPwqkVETU1imD-zy5yVvQ9trmRJgmtzT7rs_CEpRbrLjOFuyI2WX7Eq4JjC6DntDN-sIYJTeXxAN737Q6Lsdh2WFB09FdYlpUrWCn5Ti-v_s6Z56zAvtQVc79hEBS-aI/s1600/Acer+Service+Centre.jpg" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                </div>
                                <a href="https://maps.app.goo.gl/yKofnsxQwS64JpNZA" class="h4">Acer Customer Service Center - Denpasar</a>
                                <p class="my-4"></p>
                                <a href="https://maps.app.goo.gl/yKofnsxQwS64JpNZA" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Maps</a>
                            </div>
                        </div>
                    </div>
                </div>
